...
class Register(models.Model):
    ...
    required_batch_time = models.TimeField(null=True, blank=True)
...
class Instructor(models.Model):
    ...
    instructor = models.ForeignKey(Register, on_delete=models.CASCADE, related_name='Batch.batch_name+')
...
class Services(models.Model):
    ...
    picture = models.FileField(upload_to='service')


class Equipment(models.Model):
    equipment = models.CharField(max_length=50)
    picture = models.FileField(upload_to='equipment')
...
class UserHealth(models.Model):
    ...
    medicine_consumption = models.TextField(max_length=50)
...
class FirstAid(models.Model):
    ...
    first_aid1 = models.CharField(max_length=50, blank=True, null=True)
